# 更新日志
## 2025-09-30
- 修复：在login失败的情况下异常导致程序崩溃。
- 增强稳定性：兼容了在pikpak离线资源卡在99%进度，但实际已经可以下载的情况。
...
- [ ] 新增资源链接队列和队列top轮询机制，以防在当前没有空余可用账号的情况下资源链接直接判定为失败的情形。
- [ ] 新增查询任务状态接口，随时查看下载中和等待下载的任务状态。
- [ ] 继续增加稳定性，防止异常导致程序崩溃的情况。
